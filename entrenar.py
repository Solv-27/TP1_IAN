...
def main():
    ...
    parser.add_argument("--episodios", type=int, default=50000, help="Número de episodios de entrenamiento")
    parser.add_argument("--alpha", type=float, default=0.05, help="Tasa de aprendizaje (alpha)")
